...
echo  "|              Instagram       : ahmadbagusalmubaroq        |" | lolcat
echo  "|              Facebook        : Iyo Gus                    |" | lolcat
...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"AHMADBAGUSALMUBAROQ"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Instagram :"$i" ahmadbagusalmubaroq"
echo $ku"Facebook  :"$i" Iyo Gus"
sleep 2
